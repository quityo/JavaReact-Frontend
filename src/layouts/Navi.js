    ...
    <div>
      <Menu inverted fixed="top">
        ...
        <Container margin="auto">
          ...
          >
            <Image
              style={{ width: "35px", height: " 40px", margin: "0 15px 0 0" }}
              src={
                "https://res.cloudinary.com/fufufu/image/upload/v1625168938/yqkd4vauoa5tvmif7gq2.png"
              }
            ></Image>
          ...
          <Menu.Item
            active={activeItem === "jobadvert/add"}
            onClick={handleItemClick}
            as={NavLink}
            to="/jobadverts/add"
            name="İlan Ver"
          ...
          <Menu.Menu position="right">
            <div style={{ margin: "auto" }}>
              ...
              {authItem[0].loggedIn && authItem[0].user.userType === 1 && (
                <Button color="orange" as={Link} to={`/favorites`}>
                  <Icon name="heart" />
                  Favori İlanlar{" "}
                </Button>
              )}
            ...
            <div style={{ margin: "auto" }}>
              {authItem[0].loggedIn && authItem[0].user.userType === 3 && (
                <Dropdown item style={font} text="Admin List">
                  <Dropdown.Menu>
                    <Dropdown.Item as={Link} to="/registeremployee">
                      Employee Add
                    </Dropdown.Item>
                    <Dropdown.Item
                      as={Link}
                      to={`/employees/${authItem[0].user.userId}`}
                    >
                      Employee Details
                    </Dropdown.Item>
                    ...
                    <Dropdown.Item as={Link} to={"/employers"}>
                      Employer List
                    </Dropdown.Item>
                    <Dropdown.Item as={Link} to={"/confirmjobadvert"}>
                      Job Confirm
                    </Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
              ...
              {authItem[0].loggedIn && authItem[0].user.userType === 2 && (
                <Dropdown item style={font} text="Employers">
                  <Dropdown.Menu>
                    ...
                    <Dropdown.Item as={Link} to={"/jobadverts/add"}>
                      Job Add
                    </Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
