        ...
        <Table.Body>
          {cvs.map((cv) => (
            ...
            {/*   <Table.Cell>
              ...
              <Table.Cell>
                <a href={cv.githubAddress} target={"_blank"} rel="noopener noreferrer">
              ...
              <Table.Cell>
                <a href={cv.linkedinAddress} target={"_blank"} rel="noopener noreferrer">
              ...
              <Table.Cell>
                <Button color="green" animated as={Link} to={`/cvlist/${cv.jobseeker.userId}`}>
