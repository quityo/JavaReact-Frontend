...
export default function RegisterEmployee() {
  ...
  const employeeRegisterSchema = Yup.object().shape({
    firstName: Yup.string().required("Kullanıcı adı zorunludur").min(2,"Kullanıcı adı en az iki uzunlukta olmalıdır"),
    lastName: Yup.string().required("Kullanıcı soyadı zorunludur").min(2,"Kullanıcı soy adı en az iki uzunlukta olmalıdır"),
      ...
      <Form size="large" onSubmit={formik.handleSubmit}>
        <Segment stacked>
          ...
          <div style={{marginTop:"1.5em"}}>
              <label margin="auto"><b>Email</b></label>
