      ...
      <Card.Group>
        <Card fluid>
          <Card.Content style={{ backgroundColor: "#F2F4F4" }}>
            ...
            <Card.Description>
              <strong>"{employer.companyName}" </strong> is a unified team of
              performance marketing, design, and video production
              <br /> experts that delivers customized digital experiences and
              strategies.
            </Card.Description>
            <br />
            <Card.Meta>
              E-mail: {employer.email} <br /> Tel: {employer.phoneNumber}{" "}
            </Card.Meta>
          </Card.Content>
          <Card.Content extra>
